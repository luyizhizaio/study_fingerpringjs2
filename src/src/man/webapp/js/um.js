...
function(e, t, n) { (function(t) {
        ...
        function i(e, t) {
            ...
            return r ? r.value = t: (r = p.createElement("input"), r.type = "hidden", r.name = "um_token", r.value = t, e.appendChild(r)),
            r
        }
        var o = n(3),
        s = (n(4), n(11)),
        ...
        T = {
            ...
            alipay: function() {
                var e, t = u.get("home-username");
                return t && (t = m(t), e = t.match(/^(\d+?)\|/), e && 2 === e.length) ? m(t.replace(e[0], "")).value: void 0
            },
            alibaba: function() {
                var e, t, n = p.getElementById("alibaba-login-box");
                return n && (e = n.src, t = /loginId=(?:([^&#]*)|&|#|$)/.exec(e)) ? decodeURIComponent(t[1]) : void 0
            }
        },
        v = "3.2.2",
        S = {
        ...
        M = {
            cn: "https://localhost/um.htm",
            us: "https://localhost/um.htm",
            daily: "https://localhost/um.htm"
        };
        o.trigger("main.load", {
            defaultOptions: S
        });
        var E = function() {
            ...
            var t = d._sec_module = d._sec_module || {};
            if (t.token) return "C" + t.token;
            var n = +new Date,
            r = "_uab_collina",
            a = c.get(r);
            a || (a = n + e(11), c.set(r, a, null, 3650, "/"));
            var i = a + n + e(3);
            return t.token = i,
            "C" + i
        },
        C = function(e) {
            e = e || {},
            e.serviceUrl = e.serviceUrl || M[e.serviceLocation],
            this.options = e,
            this.status = 0,
            this.clientToken = E(),
            this.asyncCollect = [],
        ...
        C.prototype = {
            ...
            init: function() {
                ...
                e.closeImage || l.log(e.serviceUrl.replace("um.json", "clear.png") + "?xt=" + this.getToken() + "&xa=" + e.appName),
                this.run()
            },
            run: function() {
                var e = this,
                ...
                t.formId && a(t.formId).then(function(t) {
                    i(t, e.getToken())
                }),
                e.setOptionsData();
                var n = e.asyncCollect.concat(g.asyncCollect);
                0 === n.length ? e.send() : l.allSettled(n).then(function() {
                    e.send()
                })
            },
            set: function(e, t) {
            ...
            send: function() {
                ...
                if (t.noRequest) try {
                    ...
                    e.status = 4;
                    var r = "ENCODE~~V01~~" + s.encode(e.getData());
                    o.trigger("UM.send", {
                        data: r
                    }),
                    l.post(t.serviceUrl, r).then(function(n) {
                        n && "id" in n ? (e.status = 255, n.id && h.set(g.storeKey, n.id)) : e.status = 200;
                        try {
                            t.callback(n)
                        } catch(r) {}
                        e.endTime = new Date,
                        u.set(g.storeTimeKey, e.endTime - e.startTime),
                        n.tn && (e.serverToken = n.tn, u.set(g.tkCache, l.toJson({
                            t: +new Date,
                            tk: n.tn
                        })), t.formId && a(t.formId).then(function(e) {
                            i(e, n.tn)
                        }))
                    })["catch"](function(e) {
                        t.errorCallback && t.errorCallback(e)
                    })
                }
            }
        };
        ...
        w = {
            ...
            getStatus: function(e) {
                return e ? b.status: b.status >= 200
            },
            getData: function() {
                return b.getData()
            },
            ...
            init: function(e) {
                ...
                if (n.enabled) {
                    if (r && !e.token) try {
                        if (A) return;
                        if (A = m(u.get(g.tkCache) || "{}"), A.t && new Date - A.t < 144e5) return void(e.formId && a(e.formId).then(function(e) {
                            i(e, A.tk)
                        }))
                    } catch(o) {}
                    y[t] || (y[t] = !0, b = new C(n), b.init())
                }
            }
        };
        ...
        var _ = d.umx && d.umx.version >= "3.1.0"; (d.pointmanx || d.pointman) && (d.pointmanx || d.pointman).define("um",
        function() {
            return _ ? d.umx: w
        }),
        _ || (d.umx = w),
...
function(e, t, n) { (function(t) {
        ...
        var v = {
            ...
            getDataFromDaily: function() {
                m.nce = s.cookieEnabled;
                var e = s.platform;
                e && (m.npf = e.split(" ").shift()),
                m.nacn = s.appCodeName,
                m.nan = s.appName,
                m.nlg = s.language,
                m.sw = i.screen.width,
                m.sh = i.screen.height,
                m.saw = i.screen.availWidth,
                m.sah = i.screen.availHeight,
                m.bsw = o.body.clientWidth,
                m.bsh = o.body.clientHeight,
                m.eloc = encodeURIComponent(r()),
                m.etz = function() {
                    var e = new Date;
                    e.setDate(1),
                    e.setMonth(5);
                ...
                m.ett = (new Date).getTime();
                var t = this.getDataFromCanvas();
                "" != t && (m.ecn = c.hash(t)),
                m.eca = l.get("cna"),
                m.est = h.storageType,
                m.ms = p.get(h.storeTimeKey);
                try {
                    m.xs = d.get(h.storeKey)
                } catch(n) {}
            },
...
function(e, t, n) { (function(t) {
        ...
        e.exports = {
            ...
            get: function(e) {
                ...
                var n;
                return (n = t.value) ? n: (n = a.get(e)) ? (o.storageType = 2, n) : (n = r.get(e), n ? (o.storageType = 16, n) : void 0)
            },
            remove: function(e) {
                r.remove(e),
                a.remove(e),
